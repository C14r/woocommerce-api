...
{
    /**
     * Set the "action" query parameter.
     *
     * @param string $value The value of the "action" query parameter.
     * @return self The QueryHelpers trait instance.
     */
     ...
     *
     * @param string $value The value of the "after" query parameter.
     * @return self The QueryHelpers trait instance.
     */
     ...
     *
     * @param string $value The value of the "amount" query parameter.
     * @return self The QueryHelpers trait instance.
     */
    ...
    /**
     * Set the "api_refund" query parameter.
     *
     * @param bool $value The value of the "api_refund" query parameter. Default is true.
     * @return self The QueryHelpers trait instance.
     */
    ...
    /**
     * Set the "attribute_id" query parameter.
     *
     * @param int $value The value of the "attribute_id" query parameter.
     * @return self The QueryHelpers trait instance.
     */
    ...
    /**
     * Set the "attribute_term" query parameter.
     *
     * @param string $value The value of the "attribute_term" query parameter.
     * @return self The QueryHelpers trait instance.
     */
